...
Validar msg toaster "${text}"
    Wait Until Element Is Visible       id=com.example.cursoappium:id/snackbar_text         
    Element Should Contain Text         id=com.example.cursoappium:id/snackbar_text         ${text}

Validar msg erro campo vazio "${text}"
    Wait Until Element Is Visible       id=com.example.cursoappium:id/textinput_error         
    Element Should Contain Text         id=com.example.cursoappium:id/textinput_error       ${text}